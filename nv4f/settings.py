...
SECRET_KEY = 'django-insecure-!2r1=2e2v8ots&me=(=iw#z#7$6h3x%sia+aiai0-qzem6i07h'
...
WSGI_APPLICATION = 'nv4f.wsgi.application'
...
ACCOUNT_EMAIL_REQUIRED = False # User email 필수 여부
